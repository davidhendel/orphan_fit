...
if len(sys.argv) > 2:
	...
	if pm_prior_on:
		outname = 'samples_log_'+simname+'_pm.npy'
	else: outname = 'samples_log_'+simname+'.npy'
	...
	rh_interp = interp1d(v_cArray,r_hArray)
	if pm_prior_on:
		outname = 'samples_log_'+name+'_pm.npy'
	else: outname = 'samples_log_'+name+'.npy'
